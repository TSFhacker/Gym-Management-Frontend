...
const StaffDetail = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      api.put(`api/v1/gymstaff/update?id=${id} `, values).then((res) => {
        if (res.status === 200) {
          swal({
            title: "Success!",
            timer: 2000,
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="w-full flex flex-col gap-1">
                      ...
                      <div className="w-4/5 flex flex-col space-y-1">
                        ...
                        dark:focus:border-blue-500 disabled:bg-slate-100"
                        />
                      ...
                      <div className="flex gap-2">
                        ...
                        <div className="w-full flex flex-col space-y-1 mb-8">
                          ...
                          <input
                            ...
                            className="outline-none bg-gray-50 border border-gray-300
                        ...
                        <div className="w-full flex flex-col space-y-1 mb-8">
                          ...
                          <input
                            ...
                            focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                             dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                             dark:focus:ring-blue-500 dark:focus:border-blue-500 disabled:bg-slate-100"
                          ></input>
