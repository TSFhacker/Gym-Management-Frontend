    ...
    <div className="w-full flex items-center">
      ...
      <div className="flex items-center justify-between m-4 px-8 py-4 bg-white drop-shadow-lg">
        ...
        <Link
          to="#"
        >
          <IoIosAddCircle size={40} className="text-green-500 hover:text-green-600 transfrom transition-all duration-200 active:text-green-700 active:scale-19" />
        </Link>
      </div>
                  ...
                  >
                    ...
                    <td className="p-[15px]">
                      <div className="flex gap-2 items-center">
                        <div className="bg-red-600  cursor-pointer p-[8px] inline-block rounded-sm">
                          <FiTrash2
